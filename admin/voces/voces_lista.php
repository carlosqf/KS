...
<div id="main" style="height: 85%;">
  ...
  <div id="menu" class="box">
    ...
    <ul class="box">
      ...
      <li><a href="usuario_lista.php"><span>Usuarios</span></a></li>      
    ...
    <div id="aside" class="box">
      <div class="padding box">
        ...
        <form action="voces_busqueda.php" method="get" id="search">
          <fieldset>
          <legend>Buscar voz o sinonimo</legend>          
            <input placeholder="Voz o sinonimo" type="text" name="texto" size="17" class="input-text" id="texto_busqueda" />
            &nbsp;
            <input type="submit" value="OK" class="input-submit-02" id="buscar" />
            <br />            
          </fieldset>
        ...
        <p id="btn-create" class="box"><a href="usuario_registrar.php"><span>Crear nueva voz</span></a></p>
      </div>
      <!-- /padding -->
      <ul class="box">
        ...
        foreach($lista_voces as $voces_reg) {
            ...
            <tr>
                ...
                <td width="7%" align="right">                    
                    <a href="usuario_espacio.php?id=<?php echo $id_voz;?>">Editar</a>
                </td>
            </tr>
            <?php                    
        }                
