...
/**
 * Description of dat_cliente
 *
 * @author CARLOS - FREDDY
 */
...
class dat_cliente {
    ...
    public function registrar() {
        $this->con->conectar();
        $consulta = "insert into to_clientes values(default,'$this->identificadorempresa','$this->username','$this->password',$this->id_rol,'$this->nombre','$this->telefono',$this->activo,$this->borrado);";
...
where id = $this->id;";
    ...
    public function buscarUsuario() {
        $this->con->Conectar();
        $consulta = "select id, nombre, activo from to_clientes where nombre LIKE '%$this->nombre';";
        $result = $this->con->getArray($consulta);
        $this->con->desconectar();
        return $result;
    }
